    ...
    return (
      <div className="pt-24 pb-16 min-h-screen bg-background honeycomb-bg font-body">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div 
            className="prose prose-sm max-w-none text-text-main space-y-6 text-sm leading-relaxed"
  ...
  return (
    <div className="pt-24 pb-16 min-h-screen bg-background honeycomb-bg font-body">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="prose prose-sm max-w-none text-text-main space-y-6 text-sm leading-relaxed">
          {fallbackContent}
        </div>
      </div>
    </div>
