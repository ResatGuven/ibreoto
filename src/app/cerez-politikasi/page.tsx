      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        >
          ...
          <div className="prose prose-amber max-w-none font-body text-text-muted leading-relaxed space-y-6">
            <p>
              ARI HAYAT olarak, çevrimiçi mecralarımızı ziyaretleriniz sırasında deneyiminizi geliştirmek için çerezler, pikseller, gifler gibi bazı teknolojilerden (“çerezler”) faydalanmaktayız.
            </p>
