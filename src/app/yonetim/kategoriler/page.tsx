    ...
    <div className="p-6 bg-background min-h-screen text-text-main">
        ...
        <div className="bg-white border-gray-200 shadow-sm backdrop-blur-xl p-6 rounded-2xl border border-gray-200 mb-6 shadow-lg">
          ...
          <form className="space-y-4" onSubmit={handleSave}>
            ...
            <div className="flex justify-end space-x-2">
              <button type="button" onClick={() => setIsAdding(false)} className="bg-white border border-gray-300 hover:bg-gray-100 text-gray-700 px-4 py-2 rounded-lg font-heading font-bold text-sm uppercase transition-colors">Vazgeç</button>
              <button type="submit" className="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg font-heading font-bold text-sm uppercase transition-colors">Kaydet</button>
            </div>
          </form>
        </div>
      )}
      ...
      <div className="bg-white border-gray-200 shadow-sm rounded-2xl border overflow-hidden">
        <table className="w-full text-left font-body text-sm">
          <thead className="bg-gray-50 border-b border-gray-200 font-heading font-bold text-gray-700 text-xs uppercase">
            <tr>
          ...
          <tbody className="text-gray-900">
            {loading ? (
              ...
              <tr key={cat.id} className="border-t border-gray-200 hover:bg-gray-50 transition-colors">
